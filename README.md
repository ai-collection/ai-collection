...
<div align="center">
    ...
    <h4>Agentic AI Production Studio for Consistent Characters, Workflows & Video</h4>
    <p>An agent-ready creative platform for end-to-end AI production: train LoRAs for character and brand consistency, wire multi-step pipelines in Flow Studio, assemble shorts in a timeline video editor, and drive it all from the browser or the tft CLI built for AI assistants. Also maintain consistency through image references.</p>
    <a href="https://thataicollection.com/redirect/thefluxtrain" target="_blank"><b>Get Started with TheFluxTrain</b></a>
    <br />
</div>
...
<div align="center">
    ...
    <h4>GitHub - kerbelp/metatron: Metatron is a self-hosted system that captures a codebase's real implementation decisions — preferred patterns, rejected approaches, edge cases, internal conventions — as structured priors, and serves them to coding agents over M</h4>
    <p>Metatron is a self-hosted system that captures a codebase's real implementation decisions — preferred patterns, rejected approaches, edge cases, internal conventions — as structured priors, and serves them to coding agents over MCP (Model Context Protocol). The goal: an agent writes code like a senior engineer who already knows the codebase - kerbelp/metatron</p>
...
AI Art Create is a multi-model AI image and video generator built for creators tired of juggling five separate subscriptions. Generate with Seedance, Kling AI, Veo 3, Nano Banana Pro, GPT Image, Flux, Ideogram, and Recraft, all on one credit balance. Compare models side by side on the same prompt, browse the public gallery, and try your first generation free, no credit card required.
...
#### Free ATS Resume Checker - Instant ATS Score & Resume Report
...
Upload your resume to get your free ATS score and detailed report in seconds. No signup needed. Fix the issues with AI suggestions and beat the ATS.


[More Information and Pricing](https://thataicollection.com/en/application/ats-resume-checker?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Cortex - Digital Marketing Decision Engine


[Visit](https://thataicollection.com/redirect/cortex?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

AI-driven marketing platform that monitors SEO, PPC, CRO and AI channels, recommends optimizations, and can execute fixes per site.


[More Information and Pricing](https://thataicollection.com/en/application/cortex?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Striptu - Stripe to InvoiceOcean Integration — Automated Invoicing


[Visit](https://thataicollection.com/redirect/striptu?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Automatic invoicing for Stripe payments via InvoiceOcean. E-invoicing and accounting automation for 150+ tools like Kajabi, Podia, Substack. Setup in 5 minutes.


[More Information and Pricing](https://thataicollection.com/en/application/striptu?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Muse Video AI Video Generator | Text, Image & Video to Video


[Visit](https://thataicollection.com/redirect/muse-video?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Create cinematic AI videos with Muse Video. Generate, remix, and edit clips from text, image, or video — all with native, synchronized audio built in.


[More Information and Pricing](https://thataicollection.com/en/application/muse-video?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Publora — The Publishing API for the Agent Era


[Visit](https://thataicollection.com/redirect/publora?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Publora is a unified publishing API and dashboard for social media. Schedule and post to 10 platforms — LinkedIn, X, Instagram and more — from one place, with AI-assisted content and an official MCP server so developers and AI agents can automate publishing. One API key, one call, ten networks. Free to start.


[More Information and Pricing](https://thataicollection.com/en/application/publora?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Free AI Photo Editor | Flux Kontext - PhotoGenerator AI
...
photogenerator is a free AI photo generator that turns text prompts into stunning, high-resolution photos in seconds with models like GPT Image 2 and Nano Banana 2.


[More Information and Pricing](https://thataicollection.com/en/application/photogenerator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
AI Agent Store helps you launch hosted OpenClaw and Hermes agents, generate setup files, use Claw Starter Kits, discover AI agents, and publish paid Claw Earn tasks.
...
#### The best undetectable AI rewriter and detection remover.
...
#### AIVA is your personal AI music generation assistant.
...
Audialab offers a range of AI-powered audio tools designed specifically for artists, providing innovative solutions for sound creation.
...
#### Find clarity and guidance with our free Yes or No Tarot.
...
Fully managed NLP-as-a-Service delivered via API, at 30% the cost of competitors. Switch easily with industry-standard feature parity.
...
StockGPT is an AI-powered search tool for financial research, offering insights on earnings releases and reports for S&P 500 and Nasdaq companies.
...
MRGN.AI offers AI-driven insights for restaurants, optimizing costs, improving team communication, and enhancing profitability with real-time analytics.
...
#### GitHub - kerbelp/metatron: Metatron is a self-hosted system that captures a codebase's real implementation decisions — preferred patterns, rejected approaches, edge cases, internal conventions — as structured priors, and serves them to coding agents over M


[Visit](https://thataicollection.com/redirect/metatron?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Metatron is a self-hosted system that captures a codebase's real implementation decisions — preferred patterns, rejected approaches, edge cases, internal conventions — as structured priors, and serves them to coding agents over MCP (Model Context Protocol). The goal: an agent writes code like a senior engineer who already knows the codebase - kerbelp/metatron
...
Audio Enhancer provides tools for noise removal, vocal isolation, and echo reduction to enhance your audio files effectively and efficiently.
...
#### Remove Image Backgrounds with great quality at an unbeatable price.
...
Describe what you want to build. AI writes the code, deploys it live, and iterates with you. Build landing pages, SaaS apps, admin panels, e-commerce stores ...
...
#### AI Business App Builder: Apps, Agents & Workflows | Taskade


[Visit](https://thataicollection.com/redirect/taskade?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Build CRMs, dashboards, and client portals from one prompt. Taskade Genesis turns business processes into live apps with agents, automations, and memory.
...
#### Simplify your SQL querying experience.


[Visit](https://thataicollection.com/redirect/querygenie?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

QueryGenie is an innovative tool designed to streamline SQL query generation for users.
...
#### Transform natural language into SQL queries easily.


[Visit](https://thataicollection.com/redirect/text2sql?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Text2SQL.AI allows users to convert text-based queries into SQL commands effortlessly.
...
#### Your #1 AI dating assistant for Tinder, Bumble & Hinge.
...
#### Transform your products into stunning visuals with AI-powered photography.


[Visit](https://thataicollection.com/redirect/zust-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Professional product photography without expensive equipment, creating e-commerce ready images in seconds with perfect lighting and backgrounds.
...
#### CakhiaTV - Xem trực tiếp bóng đá cực đỉnh World Cup Top 1
...
IntelliMail is a Chrome extension that generates your emails, ensuring you never have to write one again while protecting your privacy.
...
SalesStream streamlines your sales process through automation and AI-driven insights.
...
StarVoice AI specializes in enhancing voice communication through intelligent AI. Designed for individuals and businesses alike.
...
#### How Attractive am I - AI Beauty Score Test[Update 2026]
...
Free Attractive Test Your photo online to get a beauty score. Wondering how pretty am I? Find out now with our advanced facial analysis tool.
...
#### Your objective facial beauty score awaits!
...
#### Transform your photos with advanced AI face swapping technology.
...
Reface offers innovative AI-powered mobile applications that allow users to swap faces, design tattoos, and create unique media experiences.
...
#### Instantly swap faces with AI Face Swap online for free.
...
#### Effortless virtual try-ons with innovative AI outfit changing for every style and body type.
...
#### DUMDUM4D : Situs Gacor Deposit Qris & Terpercaya Resmi Community Internasional
...
DUMDUM4D adalah situs slot resmi dengan deposit qris, minimal depo 10k saja. Menyediakan provider game terbaik dan paling besar tingkat kemenangan nya, Serta sudah bersertifikat community internasional.
...
#### Effortless virtual try-ons meet innovative AI outfit changing for every style and body type.
...
#### Transform your ideas into engaging content effortlessly.


[Visit](https://thataicollection.com/redirect/swagai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Swag AI simplifies content creation using artificial intelligence, making it easy for users to generate high-quality written material.
...
#### Inworld AI – The #1 Realtime Voice AI


[Visit](https://thataicollection.com/redirect/inworld?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

#1 realtime TTS with under 200ms latency, voice cloning, and prices cut by half or more for most developers. Realtime agents built for scale.
...
#### The world’s most comprehensive geospatial intelligence platform.


[Visit](https://thataicollection.com/redirect/latitude?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Latitude provides a powerful platform for accessing and analyzing geospatial data.
...
#### Interactive Chess AI powered by Betafish.js


[Visit](https://thataicollection.com/redirect/chess-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

An interactive chess AI that allows you to play against various difficulty levels.
...
The domain text2present.com is currently registered and managed by INWX.
...
#### #1 For Professional AI Headshots
...
#### Empowering enterprises with AI-driven insights.


[Visit](https://thataicollection.com/redirect/getactyv?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Actyv is a platform designed to help businesses leverage AI for improved decision-making and operational efficiency.
...
#### AI Study Tools built for students.


[Visit](https://thataicollection.com/redirect/solvely?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Use Solvely for homework help, exam prep, AI notes, flashcards, quizzes, and study guides across Web, iOS, Android, and Chrome.
...
Transform static images into dynamic, moving videos and create realistic photos tailored to your needs using AI.
...
#### Transform your photo editing workflow with AI.


[Visit](https://thataicollection.com/redirect/photoshift?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

PhotoShift automates the labor-intensive parts of photo editing for photographers and creative professionals.
...
WaifuXL allows users to download images of popular characters known as waifus.
...
AVCAI is a comprehensive suite of AI-powered tools designed for enhancing images and videos online. It offers a variety of features including upscaling, denoising, background removal, color correction, and more.
...
#### Imglarger | AI Image Enlarger, Enhancer, Sharpener, Uncrop and Converter
...
Use Imglarger to enlarge images, enhance photo quality, sharpen blurry pictures, uncrop and expand photos, restore old images, remove backgrounds, and convert image formats online.
...
#### ImgUpscaler | AI Image Upscaler to Upscale Images Online
...
Use ImgUpscaler to upscale images online by 2x or 4x, enhance photo details, and create sharper visuals for web, print, ecommerce, anime, portraits, and old photos.
...
Turn your images into beautiful anime-style art with our easy-to-use platform.
...
Create realistic AI kissing videos with AIKissify’s AI Kissing Generator online for free. Generate romantic scenes instantly from text or photos. Try now.
...
#### AI Interview Copilot for real-time support.
...
#### Revolutionize your interview preparation.
...
Mind Interview is an AI-based platform designed to enhance your interview skills and boost your chances of landing your dream job.
...
#### Revolutionizing food choices with AI technology.


[Visit](https://thataicollection.com/redirect/foodai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

FoodAI provides personalized food recommendations using advanced algorithms to enhance dietary choices and nutrition.
...
#### Stork.AI — See if AI recommends you, or your competitor


[Visit](https://thataicollection.com/redirect/graphic-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Run an AI Reputation Report: see whether ChatGPT, Perplexity, Gemini, Claude & Grok name you — or your competitor — when buyers ask what to buy and clients ask who to hire. Free preview. Plus the AI tools directory.
...
Fathom summarizes your meetings so you can focus on the conversation with AI-powered instant call summaries and integrations.
...
#### Create a unique, brandable business name using AI.
...
NameFinder helps you generate and discover unique names for your projects, businesses, or products.
...
#### Generate catchy names for your podcast in seconds.
...
The Podcast Name Generator helps you create unique and engaging podcast names effortlessly.
...
IndexApps allows you to create engaging videos using AI avatars and templates in under 2 minutes, perfect for social media and ads. No filming or complex setup required.
...
#### Analyze data in your own languages seamlessly.


[Visit](https://thataicollection.com/redirect/rtutor?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

RTutor translates natural language into R (or Python) code for data analysis. Upload your data, ask questions, and get results in minutes.
...
imgAk: ImgAk AI高清放大器，一键将模糊图片转为超清高清图像，增强图片画质，支持最高16000像素无损放大，智能修复细节、增强纹理、还原色彩，专为产品、广告、动漫、人像、风景、历史字画等场景优化。不仅放大，更智能补全缺失细节，修复损坏像素，获得更清晰、更鲜艳色、更高细节的图像。直出300DPI高精度输出，完美适配专业打印需求。上传即得惊艳画质——让低清变清晰，让模糊变锐利。 / imgAk AI婚纱照生成器，上传人物或情侣照片，一键生成韩式棚拍、中式秀禾、海边夕阳、森系草坪、教堂仪式、法式复古、杂志风婚纱写真。适合婚礼纪念照、订婚照、社媒头像，强调人脸相似、真实肤质与高级影楼质感。 / 专业级AI人像修图，肤质增强，秒变精致，告别繁琐修图！AI自动完成祛痘、去瑕疵、磨皮、瘦脸与美白美颜，同步优化肤色不均与暗沉，还原你本该拥有的清爽、透亮、自信状态，轻松拥有杂志级人像质感，摄影设计师必备。 / ImgAk AI相似图生成器，一键基于原图智能裂变创意版本，二创神器；精准分析风格、构图元素，支持主体改造、换背景、换色调、调光影、换镜头角度等，让一张图快速裂变多张设计素材、电商主图、广告图、海报和品牌素材
...
#### A simple JavaScript library for identifying unseemly images.
...
#### Unlock the potential of AI with guided prompt engineering.
...
Learn how to craft effective prompts for various AI models and tools. Enhance your understanding of prompt engineering for improved results.
...
HireX leverages AI technology to streamline recruitment by connecting employers with the right candidates quickly and efficiently.
...
Identify & Interview Only Top Applicants With AI Shortlisting, Video Interviews, and Interview Scheduling.
...
#### The AI canvas for visual thinking.
...
#### Free AI Resume Builder: 4.3M Users, ATS-Optimized
...
Get the premium domain seoby.ai for $24,888.00 plus a transfer fee.
...
#### Situs deposit pulsa tanpa potongan terpercaya di Indonesia.
...
#### Eksplorasi Wisata Hiburan Online dan Tren Digital Asia
...
Nikmati pengalaman games online paling paling menegangkan namun hasil memuaskan dengan akomodasi yang terpercaya aman terkini di FUFUSLOT sepanjanga tahun 2026.
...
TodoBee is designed to enhance your productivity through smart task management and scheduling.
...
Enjoy features like asking your organizational apps questions, tracking important topics, setting reminders, querying documents, and summarizing conversations in Slack.
...
#### PTTOGEL - Join Link Toto Togel Online Pasaran WLA Hadiah Togel Terbesar


[Visit](https://thataicollection.com/redirect/splitjoin?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

PTTOGEL menghadirkan link toto togel online pasaran WLA dengan akses cepat, sistem aman, dan pengalaman bermain yang nyaman. Nikmati hadiah togel terbesar serta layanan profesional yang siap menemani setiap waktu.
...
#### The AI voice generator for content creators.
...
AI Video Generator, Tex-to-Video, Generative Videos, Custom Avatar, 2,000+ Avatars, AI Dubbing with Translation, TTS with 150+ Languages, and 7,000+ Video Templates — for HR Training, and YouTube Creators.
...
Explore expert guides to beaches and coastal destinations worldwide with BeachAtlas.
...
#### Explore intelligent automation with AI tools.


[Visit](https://thataicollection.com/redirect/aspen?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Discover innovative tools for automation that enhance digital experiences across various sectors from gaming to finance.
...
AI Dev Codes utilizes OpenAI's advanced ChatGPT model to allow users to create personalized web pages effortlessly through conversational prompts.
...
An agent-ready creative platform for end-to-end AI production: train LoRAs for character and brand consistency, wire multi-step pipelines in Flow Studio, assemble shorts in a timeline video editor, and drive it all from the browser or the tft CLI built for AI assistants. Also maintain consistency through image references.
...
#### Optimizing your eCommerce images with AI.
...
SellerPic enhances product images using AI to improve sales. Tailored for eCommerce businesses and marketers.
...
Automate outbound sales with AI voice agents. Qualify leads, book appointments, follow up 24/7. Live in 2 weeks. 63% conversion lift.


[More Information and Pricing](https://thataicollection.com/en/application/topcalls?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Answer, Schedule & Convert Calls Automatically!


[Visit](https://thataicollection.com/redirect/voagents?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

VoAgents is an AI-powered voice assistant designed to revolutionize customer interactions by automating phone calls, scheduling appointments, and qualifying leads 24/7.
...
Clone your voice in seconds with our cutting-edge AI technology. Create natural-sounding speech from any text with your own voice. Free and secure voice cloning service.


[More Information and Pricing](https://thataicollection.com/en/application/nicevoice?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Email scraper — Email scraping tool
...
#### Paraphrasing Tool - Best Free Online Paraphraser.
...
#### Discover Rytr, your free AI writing assistant.
...
#### Unlock Unlimited AI Creativity Across Video, Image, Music, and Writing.
