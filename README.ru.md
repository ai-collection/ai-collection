...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="Количество приложений генеративного ИИ" src="https://img.shields.io/static/v1?message=Количество приложений генеративного ИИ&color=informational&style=flat-square&label=3627" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
#### Audio Converter AI - конвертируйте аудио в текст, транскрибируйте онлайн бесплатно
...
Audio Converter AI преобразует звук в точный текст с помощью временных меток, меток динамиков и поддержки нескольких языков. Загружайте файлы MP3, WAV или M4A размером до 100 МБ и быстро получайте расшифровки, резюме и переводы. Идеально подходит для студентов, исследователей, подкастеров и профессионалов, которым требуется надежное преобразование речи в текст в Интернете.


[More Information and Pricing](https://thataicollection.com/ru/application/audio-converter-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Keevx — это готовая к использованию платформа для создания цифровых видео с людьми с искусственным интеллектом, предназначенная для рекламы в электронной коммерции, корпоративного обучения и маркетинга в социальных сетях. Она позволяет компаниям и авторам по всему миру создавать высококачественные многоязычные видеоролики без необходимости их съемки или редактирования.


[More Information and Pricing](https://thataicollection.com/ru/application/keevx?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Art Neurona — это мощная онлайн-платформа, которая позволяет создателям и профессионалам создавать, редактировать и улучшать изображения без навыков дизайна.


[Visit](https://thataicollection.com/redirect/neurona-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Воплотите свои визуальные идеи в жизнь за считанные секунды с помощью искусственного интеллекта. Art Neurona — это мощная онлайн-платформа, которая позволяет создателям и профессионалам создавать, редактировать и улучшать изображения без навыков дизайна.


[More Information and Pricing](https://thataicollection.com/ru/application/neurona-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
