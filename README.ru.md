...
#### Intempt | Агентская клиентская платформа для маркетинга и продаж


[Visit](https://thataicollection.com/redirect/intempt?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Единая агентская платформа для маркетинга и продаж. Сегментируйте клиентов, осуществляйте межканальные путешествия и прогнозируйте отток клиентов с помощью Blu. Экономьте на расходах и смотрите полную картину клиентов.


[More Information and Pricing](https://thataicollection.com/ru/application/intempt?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### ShopWriter | Генератор контента AI для WooCommerce
...
Генератор контента AI для WooCommerce: массовая оптимизация страниц продуктов и блогов с помощью SEO-заголовков, описаний, часто задаваемых вопросов, метатекста и альтернативного текста. Тысячи продуктов за считанные минуты, писатели не нужны.


[More Information and Pricing](https://thataicollection.com/ru/application/shop-writer?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Kling 5.0 — это генератор видео с искусственным интеллектом, который превращает ваш текст (и дополнительные справочные изображения) в короткие загружаемые клипы


[Visit](https://thataicollection.com/redirect/kling-5-0?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Kling 5.0 — это генератор видео с искусственным интеллектом, который превращает ваш текст (и дополнительные справочные изображения) в короткие загружаемые клипы. Начните с нескольких минут, повторите изменения, настроив одну-единственную строку подсказки, и переходите к Kling 5.0 Pro, когда вам нужно больше поколений, очереди приоритетов и более плавный темп производства.


[More Information and Pricing](https://thataicollection.com/ru/application/kling-5-0?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
