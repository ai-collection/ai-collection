...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="Количество приложений генеративного ИИ" src="https://img.shields.io/static/v1?label=%D0%9A%D0%BE%D0%BB%D0%B8%D1%87%D0%B5%D1%81%D1%82%D0%B2%D0%BE%20%D0%BF%D1%80%D0%B8%D0%BB%D0%BE%D0%B6%D0%B5%D0%BD%D0%B8%D0%B9%20%D0%B3%D0%B5%D0%BD%D0%B5%D1%80%D0%B0%D1%82%D0%B8%D0%B2%D0%BD%D0%BE%D0%B3%D0%BE%20%D0%98%D0%98&message=3419&color=informational&style=flat-square" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
#### Бесплатная проверка резюме ATS - мгновенная оценка ATS и отчет о резюме
...
Загрузите резюме в формате PDF/DOCX, чтобы мгновенно получить оценку совместимости с ATS, результаты анализа и рекомендации искусственного интеллекта по улучшению ключевых слов и форматирования.


[More Information and Pricing](https://thataicollection.com/ru/application/ats-resume-checker?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Cortex — система принятия решений в цифровом маркетинге


[Visit](https://thataicollection.com/redirect/cortex?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Маркетинговая платформа на основе искусственного интеллекта, которая отслеживает каналы SEO, PPC, CRO и AI, рекомендует оптимизацию и может исправлять ошибки для каждого сайта.


[More Information and Pricing](https://thataicollection.com/ru/application/cortex?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Striptu — это платформа, позволяющая разработчикам искусственного интеллекта переводить счета-фактуры в бухгалтерские книги. Благодаря этому Striptu подключается к местному учету и соблюдению нормативных требований. Автоматизируйте выставление счетов, собл


[Visit](https://thataicollection.com/redirect/striptu?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Striptu — это платформа, позволяющая разработчикам искусственного интеллекта оплачивать счета. Он связывает выставление счетов Stripe с местным бухгалтерским учетом и соблюдением нормативных требований по всей Европе, превращая доходы в чистые, готовые к аудиту бухгалтерские книги, а НДС, счета-фактуры и документы обрабатываются проверенными местными партнерами. Уже живу в 13 странах, включая Польшу, Германию, Францию, Испанию, Италию и Великобританию. Вы строите; ваши книги соответствуют требованиям.


[More Information and Pricing](https://thataicollection.com/ru/application/striptu?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Генератор видео Muse Video AI — внесен в коллекцию AI


[Visit](https://thataicollection.com/redirect/muse-video?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Мультимодальный генератор видео с искусственным интеллектом, который превращает текст, изображения или клипы в кинематографичное видео с встроенным синхронизированным звуком. — Генератор видео Muse Video AI - внесен в коллекцию AI


[More Information and Pricing](https://thataicollection.com/ru/application/muse-video?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Publora — API для публикации в эпоху агентов


[Visit](https://thataicollection.com/redirect/publora?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Publora — это унифицированный API публикации и панель управления для социальных сетей. Планируйте и публикуйте материалы на 10 платформах — LinkedIn, X, Instagram и других — в одном месте. Благодаря использованию искусственного интеллекта контенту и официальному серверу MCP разработчики и агенты ИИ могут автоматизировать публикацию. Один ключ API, один вызов, десять сетей. Запуск бесплатный.


[More Information and Pricing](https://thataicollection.com/ru/application/publora?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Генератор фотографий AI - создавайте потрясающие фотографии онлайн
...
Искусственный интеллект на основе браузера, который превращает текстовые подсказки или загруженные фотографии в редактируемые изображения с высоким разрешением с использованием нескольких моделей изображений.


[More Information and Pricing](https://thataicollection.com/ru/application/photogenerator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Верификация браузера AI и автономное тестирование E2E для агентов кодирования
...
Shiplight AI дает агентам по кодированию реальную проверку браузера. Проверяйте изменения пользовательского интерфейса по мере разработки, затем автоматически создавайте и поддерживайте стабильные комплексные регрессионные тесты практически без обслуживания. Создано для команд, использующих Claude Code, Cursor, Codex и другие агенты программирования на основе искусственного интеллекта.


[More Information and Pricing](https://thataicollection.com/ru/application/shiplight-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
