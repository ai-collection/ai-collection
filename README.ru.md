...
#### Резюме — автопилот для поиска работы


[Visit](https://thataicollection.com/redirect/resumly?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Resumly запускает поиск работы на автопилоте. Он находит подходящую работу, создает персонализированные резюме и подает заявки на работу, пока вы спите, поэтому вы начинаете искать вакансии, а не список дел.


[More Information and Pricing](https://thataicollection.com/ru/application/resumly?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
