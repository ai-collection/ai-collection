...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="Количество приложений генеративного ИИ" src="https://img.shields.io/static/v1?message=Количество приложений генеративного ИИ&color=informational&style=flat-square&label=4323" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
#### Bexi.ai: бесплатный гуманизатор искусственного интеллекта и детектор искусственного интеллекта
...
Обнаруживайте контент, созданный искусственным интеллектом, от таких моделей, как ChatGPT, Claude, Gemini и других.
Очеловечиватель текста с искусственным интеллектом: преобразуйте текст, созданный искусственным интеллектом, в естественный человеческий стиль.Настраиваемый языковой стиль: настраивайте тон и язык в соответствии со своими конкретными потребностями.Необнаруживаемый контент с помощью искусственного интеллекта: создавайте контент в обход инструментов обнаружения искусственным интеллектом.Бесплатн


[More Information and Pricing](https://thataicollection.com/ru/application/bexi-ai-free-ai-humanizer-and-ai-detector?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Mkdirs — лучший шаблон сайта-каталога, в котором есть списки, оплата, отправка заявок, CMS, блог, аутентификация, новостная рассылка, SEO, темы и многое другое.



[Visit](https://thataicollection.com/redirect/mkdirs?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Полный шаблон Next.js для сайтов-каталогов
Мощная CMS с интеграцией Sanity Studio
Электронные письма для регистрации и подписки через Resend
Беспрепятственные платежи и веб-хуки с помощью Stripe
Безопасная аутентификация Auth.js (электронная почта/пароль)
Поставщики социальных логинов «из коробки» (Google, Github и т. д.)
Интегрированная аналитика (Google Analytics или OpenPanel)
...
[More Information and Pricing](https://thataicollection.com/ru/application/mkdirs?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Mochi 1, разработанная Genmo, представляет собой современную модель генерации видео с открытым исходным кодом, которая устанавливает новый стандарт в создании видео на основе искусственного интеллекта.


[Visit](https://thataicollection.com/redirect/mochi-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Mochi 1 от Genmo — ведущий генератор видео с искусственным интеллектом, который революционизирует создание цифрового контента. Он известен своей высокой точностью воспроизведения и реалистичной генерацией персонажей, позволяющей с высокой точностью превращать текстовые подсказки в реалистичные видеоролики. Mochi 1 представляет собой значительное достижение в области создания видео с использованием искусственного интеллекта и представляет собой мощный инструмент для создателей и исследователей в области созд


[More Information and Pricing](https://thataicollection.com/ru/application/mochi-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Универсальный компаньон LinkedIn для опытных профессионалов.


[Visit](https://thataicollection.com/redirect/draftly?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Draftly — это универсальный пакет для автоматизации LinkedIn, созданный для того, чтобы помочь вам увеличить количество подписчиков и бизнес в LinkedIn с помощью персонализированного создания контента, автоматического планирования и продуманной генерации комментариев. С легкостью превращайте блоги, видео, популярные новости и твиты в уникальные публикации LinkedIn, используя свои аналитические данные. Одобрено LinkedIn и не содержит рисков.


[More Information and Pricing](https://thataicollection.com/ru/application/draftly?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Yomu AI — это инструмент для письма, который помогает студентам и преподавателям создавать лучшие эссе и исследовательские работы с поддержкой искусственного интеллекта.


[Visit](https://thataicollection.com/redirect/yomu-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Yomu AI предлагает инструменты редактирования и обратной связи, помогающие учащимся создавать лучшие эссе и статьи. 
Основные функции: помощник по работе с документами: помогает писать разделы с отзывами; автозаполнение с помощью искусственного интеллекта: заполняет предложения и абзацы; расширенные инструменты редактирования: дорабатывает содержимое с помощью опций расширения, суммирования и преобразования; помощник по цитированию: легко добавляет цитаты; средство проверки на плагиат: обеспечивает оригинал


[More Information and Pricing](https://thataicollection.com/ru/application/yomu-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
####  Легко очищайте записи и получайте чистый звук. Простое и эффективное восстановление аудио.Преобразуйте записи с помощью AI Audio Cleaner. Шумоподавление в реальном времени и четкость речи.
...
Используйте бесплатный AI Audio Cleaner онлайн, вы можете плавно избавиться от фоновых шумов, таких как вентиляторы, разговоры людей, лай собак, вождение автомобилей, жужжание аудиокабеля или других сред, их не должно быть в вашей записи. посередине. Используя средство для очистки звука, вы можете уменьшить шум любой аудио- или видеозаписи, интервью или подкаста.



[More Information and Pricing](https://thataicollection.com/ru/application/free-ai-audio-cleaner-online?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Опишите изображение: улучшите свои изображения с помощью описаний, созданных искусственным интеллектом
...
Describe Picture — это платформа на базе искусственного интеллекта, предназначенная для создания подробных описаний изображений, повышения доступности, SEO и создания контента. Этот мощный инструмент предназначен для создателей контента, маркетологов, преподавателей и всех, кто хочет улучшить качество и охват своего визуального контента. Ниже приводится подробное описание его ключевых функций и функций.




[More Information and Pricing](https://thataicollection.com/ru/application/describe-picture?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
