...
构建无代码对话代理，实现支持、入职和数据收集的自动化。推出与 OpenAI、Supabase 等集成的 AI 驱动的聊天体验。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/release0-build-conversational-chatbot-agents?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
