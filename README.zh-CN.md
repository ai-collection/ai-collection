...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?message=生成人工智能应用的数量&color=informational&style=flat-square&label=3546" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
#### Nano Banana AI — 免费的在线 AI 图像编辑器和生成器
...
Nano Banana AI 是一款免费的在线 AI 图像编辑器和生成器，可提供快速、准确和一致的结果。它允许用户根据文本提示创建图像，编辑和恢复照片，并直接在浏览器中探索多种艺术风格。非常适合电子商务视觉效果、数字艺术、角色一致性和照片修复。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/nano-banana-ai-free-ai-image-editor?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
