...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?message=生成人工智能应用的数量&color=informational&style=flat-square&label=2181" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
<div align="center">
    ...
    <h4>从图像和文本生成 AI 3D 模型。</h4>
    <p>TRIPO 是 VAST 于 2023 年底推出的生成式基础模型。TRIPO 在发电质量、速度、成本和成功率方面处于世界领先地位。目前，它可以在 8 秒内生成线框清晰流畅的几何图形的网格模型，这些模型可以集成到标准 3D 管道中进行编辑和调整。</p>
...
#### flux.1 图像生成器，完全免费，包括 flux.1 [Schnell]、flux.1 [Dev]、flux.1 [Pro]
...
使用 Flux Image AI 免费创作精美的 AI 艺术作品。由 flux.1 提供支持，包括 flux.1 [Schnell]、flux.1 [Dev]、flux.1 [Pro]，提供无与伦比的速度和精度。免费与 Stable Diffusion 和 Midjourney 竞争


[More Information and Pricing](https://thataicollection.com/zh-CN/application/flux-image-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Odin AI 是一款多功能 AI 工具，旨在通过自动化和人工智能驱动的功能简化工作流程、提高生产力并简化复杂任务。 



[Visit](https://thataicollection.com/redirect/odin-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Odin AI 提供了一套全面的工具，以提高生产力和简化工作流程。主要功能包括 AI 代理、人工智能驱动的笔记、自动化、PDF 分析、电子邮件生成、信息提取和文档创建。用户可以使用 PDF 聊天，总结冗长的内容，构建 AI 支持代理，并将 Odin AI 与他们最喜欢的应用程序集成，以构建自定义的工作流程。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/odin-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
解锁 Flux AI Image 的力量。开始免费创作精美的艺术品吧！ 

革新下一代高级文本到图像的开放模型，支持 flux.1 pro 和 flux.1 schnell 模型。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/luxaiimage-net?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 更好的追踪，病毒增长！轻松自动分析 Reels 和 TikToks


[Visit](https://thataicollection.com/redirect/trendly?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Trendly是一个先进的分析平台，它可以集中你来自抖音、Instagram Reels和YouTube短片的短篇内容指标。它通过提供竞争对手的见解，通过其独特的病毒性因子分析参与度，帮助创作者优化其内容策略。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/trendly?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Resmume是一款免费的简历制作工具，可帮助您在几分钟内轻松创建简历。它还提供自动使您的简历在人群中脱颖而出的功能。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/resmume-cv-maker?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### FLUX.1 Pro 代表了黑森林实验室开发的一系列令人印象深刻的 Flux AI 模型。通过免费在线使用 FLUX AI 图像生成器输入文本，轻松创建精美的图像。


[Visit](https://thataicollection.com/redirect/flux-1-pro?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

主要特征 
1。FLUX.1 Pro 非常擅长生成文本，非常适合制作精美的排版、逼真的标志和错综复杂的图像细节。
2。它可以很好地处理复杂的元素，可以创建逼真的手部图像和其他人工智能经常难以处理的精细细节。
3.它具有 120 亿个参数，可生成高分辨率图像，突出精细的细节，确保出色的清晰度和视觉质量。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/flux-1-pro?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Outpeach —与人工智能女友聊天.通过图片和语音消息进行有趣、情趣的谈话。


[Visit](https://thataicollection.com/redirect/outpeach?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

使用 Outpeach AI 点燃你隐藏的欲望。 

与虚拟 AI 伴侣一起体验有趣的互动约会模拟，无需任何承诺，他会倾听、回应和欣赏你。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/outpeach?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
