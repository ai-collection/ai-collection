...
#### Chatr 是一款尖端的应用程序，你可以在其中创建、聊天和玩逼真的 AI 角色。 


[Visit](https://thataicollection.com/redirect/chatr?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Chatr 是一款尖端的应用程序，你可以在其中创建、聊天和玩逼真的 AI 角色。无论是你完美的人工智能女友、男朋友还是任何伴侣，Chatr 都能让你将你的想象力变为现实。通过文本、语音和图像进行身临其境的 AI 聊天，再加上可供探索的精彩角色包，可能性无穷无尽！


[More Information and Pricing](https://thataicollection.com/zh-CN/application/chatr?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
🎨 使用 Slea.ai 轻松体验徽标创作，这是您快速、专业和个性化品牌推广的首选工具！


[More Information and Pricing](https://thataicollection.com/zh-CN/application/slea-ai-free-ai-logo-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 适用于 ChatGPT 和 Midjourney的最大人工智能提示库
...
利用 ChatGPT 和 Midjourney 的 30,000 多条人工智能提示来促进您的业务和营销。借助 AI 提升您的搜索引擎优化、写作、销售、生产力和视觉效果！


[More Information and Pricing](https://thataicollection.com/zh-CN/application/ai-prompt-library?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
凝聚力旨在帮助团队和个人做出更好的战略决策。其想法是通过持续评估战略决策并提供循证见解来弥合目标与行动之间的差距。我们让所有人站在同一页面上，同时随着事物的发展保持适应能力。现在，我们正在尝试将新版本交到尽可能多的人手中。




[More Information and Pricing](https://thataicollection.com/zh-CN/application/cohesion?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
####  在 Infinite Canvas 应用程序上与 AI 聊天
...
RabbitHoles AI 是一款旨在通过提供无限画布来改变人工智能交互的应用程序，其中每个节点代表一个单独的对话。与传统的线性聊天不同，该平台允许您同时进行多次人工智能对话，将它们连接起来，并将PDF和YouTube视频等其他数据源直接整合到您的工作空间中。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/rabbitholes-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Impactjustice.ai 是一个先进的创新系统，旨在帮助人们倡导格鲁吉亚监狱的人道监狱条件。在美国司法部宣布格鲁吉亚在不人道和违宪的条件下关押50,000名囚犯之后创建。《佐治亚囚犯之声》决心将这些情况提请公众注意。




[More Information and Pricing](https://thataicollection.com/zh-CN/application/georgia-prisoners’-speak?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
探索我们的 AI 漫画翻译器，进行批量、扫描或大型漫画翻译。使用我们易于使用的 Chrome 扩展程序，在浏览器中欣赏您最喜爱的漫画。



[More Information and Pricing](https://thataicollection.com/zh-CN/application/transmonkey-comic-translator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
