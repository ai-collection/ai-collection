...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?message=生成人工智能应用的数量&color=informational&style=flat-square&label=4317" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
#### 您的个性化旅行助手可帮助您创建完美的行程，生成装箱单，这样您就不会忘记任何事情，或者查看在目的地可以做哪些活动。 
...
Exploration Junkie的人工智能旅行计划器是一款旅行助手，旨在简化旅行计划。只需提供一些细节，例如目的地和日期，我们的人工智能即可根据您的喜好生成个性化行程、装箱单和活动建议。直观的聊天框允许您提出后续问题以进行实时调整，从而获得无缝的旅行计划体验。 


[More Information and Pricing](https://thataicollection.com/zh-CN/application/exploration-junkies-ai-travel-planner?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
ImageTextify 是一款功能强大且用户友好的工具，可使用先进的 OCR 技术快速将图像高精度转换为文本。它支持多种图像格式，确保对各种用例进行快速、安全的处理，为用户节省时间和精力。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/imagetextify?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Media.io 人工智能人像生成器使用人工智能快速将自拍照转换为个性化、高质量的艺术肖像。
...
Media.io AI 人像生成器是一款强大的工具，可在几秒钟内将您的自拍照转换为令人惊叹的艺术肖像。通过使用先进的人工智能算法，该工具允许用户将普通照片转换为各种创意风格，从而提供了一种表达个性和增强他们在社交媒体上的视觉效果的方式。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/media-io-ai-portrait-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Focal是一个平台，您可以在其中使用AI创建自己的电视节目和电影。
...
它将浏览器内视频编辑器与最先进的模型（Runway、Luma、Flux Pro、ElevenLabs）集成到一个简单的工具中，你可以用它来讲故事。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/focal?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Instructa.ai 教会开发者如何使用 Cursor AI 等人工智能工具更快地编码。我们的课程通过自动执行重复任务和提高编码效率来帮助您节省时间。
...
Instructa.ai 是一个教育平台，通过利用 Cursor AI 等人工智能工具，帮助开发人员更快地编写代码。我们的课程教授重复任务的自动化、提高工作效率和应用尖端技术。借助人工智能的力量，学习者可以加快开发过程，减少日常操作，专注于更复杂和更具创造性的任务。 


[More Information and Pricing](https://thataicollection.com/zh-CN/application/instructa-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Flux1.cc-免费 Flux.1 AI 图像生成器


[Visit](https://thataicollection.com/redirect/flux1-cc?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Flux.1 AI 图像生成器使用先进的人工智能技术将您的想法转化为令人惊叹的视觉效果。轻松创建独特的图像，非常适合艺术家、营销人员和内容创作者。今天就释放你的创造力！


[More Information and Pricing](https://thataicollection.com/zh-CN/application/flux1-cc?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Alive Games 使用生成式 AI 帮助游戏玩家为自己喜欢的游戏定制皮肤
...
Alive Games使用生成式人工智能来帮助游戏玩家为他们最喜欢的游戏（例如Roblox、我的世界、堡垒之夜和反恐精英2）定制皮肤和物品。只需告诉人工智能你想要什么，然后使用我们强大的 Alive Studio 来改变形状、材质、尺寸、颜色等。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/alive-games?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
