...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?message=生成人工智能应用的数量&color=informational&style=flat-square&label=3310" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
<div align="center">
    ...
    <h4>您和您的团队的第二大脑。五合一的人工智能工具可提高您的团队生产力。借助 Taskade，您的所有工作都可以在一个统一的工作空间中同步。</h4>
    <p>Taskade 是首个面向团队的协作式 AI 编写器和概述器，具有内置任务管理和视频聊天功能。创建思维导图、任务列表，并与您的团队实时进行结构化笔记。</p>
    <a href="https://thataicollection.com/redirect/taskade" target="_blank"><b>开始使用 Taskade</b></a>
    <br />
</div>
...
#### Zuzia — 服务器和网站监控、正常运行时间、SSL 检查、任务自动化


[Visit](https://thataicollection.com/redirect/zuzia-app?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

跟踪服务器指标和正常运行时间、监控 SSL、安排任务和运行远程命令——设置简单，免费套餐，无需信用卡。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/zuzia-app?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
[More Information and Pricing](https://thataicollection.com/zh-CN/application/idm-vton-online---free-online-access-for-virtual-try-ons?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
