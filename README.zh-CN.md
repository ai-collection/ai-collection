...
#### 用于创建报告、演示文稿、图表和视觉效果的 AI 电子表格



[Visit](https://thataicollection.com/redirect/bricks?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Bricks 是电子表格的 Notion 替代方案。Bricks 电子表格由 AI 提供支持，可以为你创建各种各样的东西，例如项目时间表、日历、报告、仪表板、任务跟踪器、组织结构图、看板和大量其他视觉效果。就像工作中的Canva一样，但是人工智能可以满足你的需求。Notion 风格的维基格式。全部由完整的电子表格支持



[More Information and Pricing](https://thataicollection.com/zh-CN/application/bricks?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
