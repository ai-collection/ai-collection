...
使用 LTX-2 技术创建免费的 AI 视频。使用Lightricks的在线开源视频生成器生成带有同步音频的精彩4K视频。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/free-video-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 音频到文本转换器-在线语音转文本 | transcribetotext.org
...
使用我们的 AI 转录工具立即将音频转换为文本。支持 120 多种语言、MP3、WAV、M4A 和 15 种以上格式。在几分钟内快速、准确地将语音转换为文本。无需注册-免费开始！


[More Information and Pricing](https://thataicollection.com/zh-CN/application/transcribe-audio-to-text?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
使用完美的口型同步功能创建逼真的说话视频。使用 InfiniteTalk AI 技术，将任何图像或视频转换为音频驱动的表演。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/infinitetalk-ai-video?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 使用 PicRafts 释放创造力：终极 AI 图像生成器和编辑器


[Visit](https://thataicollection.com/redirect/picrafts?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

专业的人工智能图像生成器和编辑器。使用顶级 AI 模型在几秒钟内创建、编辑和转换照片。从图像生成到人脸交换，使用 PicRafts 解锁无限的创意可能性。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/picrafts?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
