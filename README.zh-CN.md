...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?message=生成人工智能应用的数量&color=informational&style=flat-square&label=2977" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
<div align="center">
    ...
    <h4>Inkai是一款基于人工智能的纹身生成器，可根据用户输入创建个性化的纹身设计。</h4>
    <p>用户可以上传照片并描述他们想要的纹身风格和位置。

Inkai的显著特点之一是其人体映射技术，使用户可以直观地预览纹身在身上的样子。通过上传多张照片，用户可以尝试不同的设计、尺寸和位置，在获得永久墨水之前做出明智的决定。
</p>
    <a href="https://thataicollection.com/redirect/ink-ai-tattoo-generator" target="_blank"><b>开始使用 Ink AI - Tattoo Generator</b></a>
    <br />
</div>
...
#### Kie.ai：经济实惠且安全的 DeepSeek R1 API
...
Kie.ai 提供经济实惠的 DeepSeek R1 API，专为强大的推理和实时直播而设计。它具有强大的安全性和无缝集成，非常适合数学、编码和逻辑分析等复杂任务。非常适合寻求高效人工智能解决方案的开发人员、初创企业和团队。




[More Information and Pricing](https://thataicollection.com/zh-CN/application/kie-ai-affordable-and-secure-deepseek-r1-api?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 使用 CVBee.ai 的人工智能简历制作者在几分钟内创建专业简历。
...
📝 CVBee.ai 是一款人工智能驱动的简历制作工具，旨在帮助求职者有效地创建或优化简历。无论你是刚起步还是想提升自己的职业生涯，CVBee.ai 都能为你的特定行业提供量身定制的个性化、专业的解决方案。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/cvbee-ai-ai-cv-maker-free-online?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
无论你的写作经验如何，都可以使用 AI 故事生成器轻松解锁引人入胜的情节。轻松探索富有想象力的世界、错综复杂的角色和惊险的冒险。让 AI 激发你的创造力，创作独特的故事，让你的观众着迷。借助人工智能的魔力，以前所未有的方式拥抱讲故事的可能性。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/free-ai-story-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
一款多合一、易于使用的在线音频工具，包括人工智能音乐、降噪、音频增强、音频编辑和人声去除。”


[More Information and Pricing](https://thataicollection.com/zh-CN/application/audio-muse?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Humble 是一款由人工智能驱动的聊天机器人，适用于正在我附近寻找同性恋的男同性恋者。为什么不现在找个AI男朋友?你可以提高你的沟通和约会技巧.以及寻求情感支持。 


[More Information and Pricing](https://thataicollection.com/zh-CN/application/humble-ai-gay-dating-simulator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Menu Translator 应用程序可帮助你在国外尝试更多当地菜肴，让你毫不困惑地发现世界各地的美食！
...
Menu Translator 应用程序允许你为任何菜单拍照，包括棘手的手写菜单，并对其进行分析，以提供准确的翻译、详细的菜肴描述、照片和发音。它不仅限于字面翻译。借助搜索功能、突出显示功能等，您可以轻松记住自己的选择，享受无缝的国外就餐体验。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/menu-translator-app?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 一款免费的在线 AI 人脸交换工具，可让您快速安全地交换视频、图像和 GIF 中的人脸，获得高质量的结果，所有这些都无需注册。
...
FaceSwapVideo.ai 是一款基于浏览器的免费工具，无需注册即可在视频、照片和 GIF 中交换面孔。它提供快速、高质量的结果，支持单人面部和多人脸交换。凭借其简单的界面和注重隐私的设计，用户可以在知道数据安全的同时轻松创建有趣、可共享的内容。



[More Information and Pricing](https://thataicollection.com/zh-CN/application/face-swap-video-online-free?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
