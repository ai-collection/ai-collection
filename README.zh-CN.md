...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?message=生成人工智能应用的数量&color=informational&style=flat-square&label=1895" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
NewVideoAI是一款创新的视频编辑器，可通过使用AI有效地转换视频，其技术核心是基于对短视频进行细微的更改


[More Information and Pricing](https://thataicollection.com/zh-CN/application/newvideoai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Flux Pro AI 让图像生成变得更容易、更具创意！由黑森林实验室开发的Flux.1 AI具有三种强大的模型：FLUX.1 Pro、FLUX.1 Dev和FLUX.1 Schnell。这些模型可以生成各种各样的精美图像，包括逼真的图像、艺术品和概念设计。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/flux-pro-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
LambdaTest 的 KaneAI 是同类产品中的第一款 AI 测试助手，具有业界首创的人工智能功能，例如专为高速质量工程团队构建的测试创作、管理和调试功能。KaneAI 使用户能够使用自然语言创建和改进复杂的测试用例，从而显著减少了开始测试自动化所需的时间和专业知识。   


[More Information and Pricing](https://thataicollection.com/zh-CN/application/kaneai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 
Unscript：人工智能驱动的个性化视频创作变得简单


[Visit](https://thataicollection.com/redirect/unscript?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Unscript 是一个由人工智能驱动的平台，它通过 AI 头像、配音和换脸等功能简化视频创作。它允许用户为营销、培训和客户服务制作个性化的高质量视频。Unscript注重易用性和自定义，使企业和创作者能够毫不费力地制作引人入胜的独特视频内容。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/unscript?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Fairytale Generator 是一款由 AI 驱动的儿童故事生成器，为孩子的创作之旅加油。制作个性化故事从未如此简单！


[More Information and Pricing](https://thataicollection.com/zh-CN/application/fairytale-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
免费的在线人工智能驱动的简历和求职信撰写者。可自定义的简历模板和各种职称的预制简历示例。 


[More Information and Pricing](https://thataicollection.com/zh-CN/application/resume-trick?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
