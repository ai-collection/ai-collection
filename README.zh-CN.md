...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?label=%E7%94%9F%E6%88%90%E4%BA%BA%E5%B7%A5%E6%99%BA%E8%83%BD%E5%BA%94%E7%94%A8%E7%9A%84%E6%95%B0%E9%87%8F&message=3368&color=informational&style=flat-square" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
<div align="center">
    ...
    <h4>与在浏览器或桌面应用程序中本地运行的角色扮演型 AI 角色聊天——100% 免费且完全私密。
</h4>
    <p> HammerAI 是一款在本地计算机上运行的人工智能聊天，可以使用 WebGPU 在网络浏览器中运行，也可以使用 Ollama 和 llama.cpp 在下载的桌面应用程序中运行。它是免费的、私密的，不需要登录。</p>
    <a href="https://thataicollection.com/redirect/hammerai" target="_blank"><b>开始使用 HammerAI</b></a>
    <br />
</div>
...
使用优质 AI 语音大声朗读读者——在线免费大声朗读文本。无需注册，可以下载 MP3，逐字突出显示，速度可调。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/read-aloud-reader?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Podsuite — 播客转录、节目备注和内容工具


[Visit](https://thataicollection.com/redirect/podsuite?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

终极的人工智能播客工具——笔记、节目笔记、片段、章节、博客文章和社交文案。上传一次，即可获得发布和成长所需的一切。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/podsuite?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### MathPal — AI 数学导师 | 分步数学帮助


[Visit](https://thataicollection.com/redirect/mathpal?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

MathPal 是一位人工智能数学导师，帮助 6-9 年级的学生逐步学习数学。拍张照片，获得即时解释，练习并跟踪进度。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/mathpal?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 使用 GPT 图片 2 | 聊天 GPT 图像生成器 | 逼真的人工智能
...
使用我们的逼真 AI 生成器创建高质量的 Chat GPT 图像。使用 GPT Image 2 支持图像提示、编辑和快速生成。在线试用最好的聊天GPT图像生成器。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/use-gpt-image-2?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
AI 图像和照片文本编辑器，可检测和替换屏幕截图、JPG、海报和产品图像中的文本，同时保留原始布局和样式。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/image-text-editor?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
