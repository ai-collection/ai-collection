...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?message=生成人工智能应用的数量&color=informational&style=flat-square&label=3692" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
<div align="center">
    ...
    <h4>SellerPic：人工智能时装模特和产品图像和视频生成器
</h4>
    <p>SellerPic是一个专为电子商务卖家打造的AI SaaS平台，与Shopify、Facebook、抖音、Instagram和Canva无缝集成。卖家可以在SellerPic中直接导入产品图片，生成或编辑产品、模型和营销视觉效果，然后一键将其发布回商店或社交渠道。
</p>
    <a href="https://thataicollection.com/redirect/sellerpic-ai" target="_blank"><b>开始使用 SellerPic AI</b></a>
    <br />
</div>
...
#### 在 Sara2.ai 上制作带有同步音频的电影或动画风格视频，快速、简单且易于访问。
...
Sara2.ai 通过消除所有障碍来简化了 Sora 2 视频的创作。键入或上传，即可在几秒钟内获得高质量的音频同步视频。非常适合想要在不使用复杂工具的情况下获得出色效果的创作者。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/sara2-ai：free-sora-2-ai-video-generator-online?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 使用 Bunnie AI 即时将你的照片变成精彩的 AI 视频——快速、逼真、无限创意。


[Visit](https://thataicollection.com/redirect/bunnie-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Bunnie AI 将强大的 AI 模型与基于模板的视频生成相结合，帮助用户轻松制作高清视频。只需上传一张照片，从 1,000 多个热门模板中进行选择——从亲吻和拥抱到舞蹈和梦幻时刻——然后让 Bunnie AI 在几秒钟内生成你的完美视频。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/bunnie-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Lexica AI 是一款先进的人工智能图像生成器，可在几秒钟内将文本提示转换为令人惊叹的高质量视觉效果。


[Visit](https://thataicollection.com/redirect/lexica-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Lexica AI 是一款先进的人工智能图像生成器，可在几秒钟内将文本提示转换为令人惊叹的高质量视觉效果。它由稳定的扩散技术提供支持，为用户提供了探索风格、情绪和艺术理念的创作自由。Lexica AI 还具有庞大的图像库，可提供灵感和快速学习。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/lexica-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 通过 Kie.ai 的 Sora 2 API 从文本或图像创建逼真、声音同步的 AI 视频，这些视频稳定、经济实惠且易于开发者使用。
...
Kie.ai 提供了对 Sora 2 API 的强大访问权限，将强大的文本到视频和图像到视频生成功能与同步音频相结合。它专为电影般的真实感和可扩展性而打造，是开发下一代人工智能媒体工具的开发人员的理想之选。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/kie-ai-affordable-and-stable-unofficial-sora-2-api?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Bolt Dev AI 是一款创建网页的工具，允许用户无需编码即可构建专业的响应式网站。
...
Bolt Dev AI 是一款创建网页的工具，允许用户无需编码即可构建专业的响应式网站。它使用自然语言提示或简单的拖放功能来即时生成布局、设计元素和内容。非常适合企业家、小型企业和创作者，它可以节省时间，同时确保现代化、用户友好的网站设计。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/bolt-dev-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
CaricatureMaker.net是一款基于人工智能的在线工具，可在几秒钟内将您的照片转换为幽默的高质量漫画。只需上传一张清晰的正面照片，该平台的高级人工智能就会生成一个俏皮而夸张的图像，用艺术天赋捕捉您的独特特征。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/caricature-maker?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 最佳非官方 MidJourney API，具有 V7、V6 和视频模型，用于图像和视频生成
...
MidAPI.ai 是最好的非官方 MidJourney API 平台，可稳定访问 V7、V6 和 V1 视频模型。开发人员和创作者可以生成图像和短视频片段，应用样式参考（--sref）和全方位参考（--oref），并在游乐场免费测试提示。MidAPI.ai 具有多种速度模式和灵活的定价，是一款适用于个人和团队的快速、可扩展的解决方案。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/midapi-ai-unofficial-midjourney-api?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
