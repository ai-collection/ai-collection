...
#### Cognexo-一口大小、游戏化的学习和调查


[Visit](https://thataicollection.com/redirect/cognexo?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

我们的使命是帮助企业联系和发展员工，以建立一支高度敬业、技术熟练和高效的员工队伍。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/cognexo?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### AI 会议助手可将对话转化为可搜索、可共享的知识


[Visit](https://thataicollection.com/redirect/scribbl?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Scribbl 是一款人工智能会议助手，可将对话转化为可搜索、可共享的知识，同时您可以专注于重要的事情——对话。借助智能摘要、即时视频集锦和无缝集成，您的会议无需繁忙的工作即可成为可操作的情报。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/scribbl?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Content Studio是Pietra的人工智能工具，它使用户能够通过为每种产品训练自定义模型来生成营销内容。该模型可生成高质量、品牌一致的营销资产，例如产品图片、生活方式视觉效果和促销内容。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/pietra-content-studio?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
LetsCall.AI 使用类似人类的语音、无缝的日历/CRM 集成和高级通话分析自动通话。它提高了客户参与度，简化了运营，并推动了各行各业的增长。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/letscall-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
