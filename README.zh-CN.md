...
利用集成的文本、图像和音频，将想法转化为故事。撰写叙事、生成插图并创建可在 KDP 和 YouTube 上发布的内容。简化从灵感到出版的过程，将想象力转化为收入


[More Information and Pricing](https://thataicollection.com/zh-CN/application/readkidz?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Autopilot Shorts 是一款人工智能工具，专为生成不露面的视频短片而设计。它允许用户使用 GPT-4 和 Claude Sonnet 等先进技术自动创建独特的视频。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/autopilot-shorts?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
