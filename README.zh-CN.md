...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?label=%E7%94%9F%E6%88%90%E4%BA%BA%E5%B7%A5%E6%99%BA%E8%83%BD%E5%BA%94%E7%94%A8%E7%9A%84%E6%95%B0%E9%87%8F&message=3329&color=informational&style=flat-square" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
<div align="center">
    ...
    <h4>GOLOVE-Ai 约会模拟器邀请用户在安全、身临其境的环境中建立虚拟关系。 </h4>
    <p>GOLOVE 中的角色具有多样且相关的特征。详细的个人资料突出显示了关键属性，例如个人兴趣，职业背景以及身体特征，例如头发和眼睛的颜色。Ai Girl Chat 的每一次互动都让人感觉真实，由先进的对话设计和根据每个用户的喜好量身定制的场景提供支持。


</p>
    <a href="https://thataicollection.com/redirect/golove" target="_blank"><b>开始使用 GoLove</b></a>
    <br />
</div>
...
#### 人工智能约会模拟器，你必须赢得他们的青睐.AI 角色会像真实的 Tinder 配对一样发短信，记住你，如果你干了就把你变成鬼魂，如果没有火花就屏蔽你。你认为你能做到吗？
...
人工智能约会模拟器，不是聊天机器人。滑动、匹配和发短信给回复简短而真实的 AI 角色，比如 Tinder 或 Hinge 配对。他们会记住你，很快就会失去兴趣：发短信不好，他们会骗你，消灭火花然后永久屏蔽你。九个关卡，在 1 级起作用的线路在 7 级失败。免费，没有账号，在 App Store 上获得 4.8 分（满分 5 分）。你认为你能做到吗？


[More Information and Pricing](https://thataicollection.com/zh-CN/application/rizzmasterrizzmaster?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 使用 AI 将任何照片转换为视频。带有 Seedance 2.5、miniMax H3、Kling、Wan、高达 4K 的照片到视频的人工智能生成器。免费积分，无需订阅。
...
照片到视频是一个 AI 图像到视频生成器。上传一张照片，使用包括 Seedance 2.5、MiniMax H3、Kling 和 Wan 在内的领先模型为其制作动画，导出至 4K。免费积分开始，按视频付费，无需订阅。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/photo-to-video?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Presentation Intelligence 是一个人工智能原生内容创作和共享平台，由多模态人工智能、设计引擎和智能编辑器提供支持。用户可以输入提示或上传 PDF、PPT、Word 文件、网页、图像、笔记或数据，Pi 将组织内容、生成视觉效果、设计布局并创建用于商业、教育、培训、报告和营销的专业演示文稿。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/presentation-intelligence?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 多合一 AI 图像转 3D 和 STL 在线转换器| Image3D AI


[Visit](https://thataicollection.com/redirect/image3d-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

使用多个 AI 引擎将图像转换为 3D 模型（STL/OBJ/GLB）；包括 PBR 纹理、重新拓扑、UV 解包。— 一体式 AI 图像到 3D 和 STL 在线转换器| Image3D AI


[More Information and Pricing](https://thataicollection.com/zh-CN/application/image3d-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### AI 歌曲生成器和 AI 歌词生成器 — 使用 AI 人声、MIDI 和词干将歌词、文本或活页乐谱转换为完整歌曲。


[Visit](https://thataicollection.com/redirect/lacuna?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Lacuna 是一个围绕 AI 歌曲生成器和 AI 歌词生成器构建的 AI 音乐工作室：使用 AI 人声将歌词、文本或活页乐谱转换为完整歌曲，根据提示或图像生成 MIDI，将词干分成最多 6 个部分，并掌握已完成的曲目。付费计划包括商业权利。提供 9 种语言版本。注册即可获得每月免费积分并开始创作。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/lacuna?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Tenorshare AI 数学求解器是一款免费的在线工具，旨在帮助您轻松解决任何数学问题。无论您在文本、图像还是文档中遇到问题，我们的 AI 都可以提供清晰的分步答案。通过视频讲解和练习来增强您的理解，直到您掌握概念为止。



[More Information and Pricing](https://thataicollection.com/zh-CN/application/tenorshare-ai-math?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
