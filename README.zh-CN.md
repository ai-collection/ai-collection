...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?message=生成人工智能应用的数量&color=informational&style=flat-square&label=2822" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
#### FaceShapes-10 秒测试脸部形状 


[Visit](https://thataicollection.com/redirect/faceshapes?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

脸型分析报告、眼镜和发型推荐都来自一张照片。此外，还有更多面部特征提示和美容技巧。
无需注册，免费使用，照片只能保存在您的设备上。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/faceshapes?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
WUI.AI 利用人工智能将长篇视频转换为适用于抖音、Instagram和YouTube Shorts等平台的简短而有影响力的片段。
面向各种内容创作者，例如播客、视频创作者和社交营销人员。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/wui-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
采访 Copilot 以获得实时支持。无限会话、双重响应和尖端的人工智能模型。
在线求职面试即将来临？我们的 AI 访谈 Copilot 为您提供了 30 多种语言的实时答案。
详细描述：
...
#### Sigma AI 浏览器是最好的人工智能驱动产品，内置了 SigmaGPT 技术。它允许人们与人工智能聊天，生成图像，总结文章。多合一浏览器。
...
使命很明确：取代传统浏览器，因为Sigma AI浏览器带来了当今的未来。它既简单又直观。它打破了障碍，将您的在线空间转变为一个集隐私、速度和技术于一身的安全创新场所。 



[More Information and Pricing](https://thataicollection.com/zh-CN/application/sigma-ai-browser?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Soshial 是一体化的人工智能平台，可以增加你的 LinkedIn 受众


[Visit](https://thataicollection.com/redirect/soshial?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Soshial是你在LinkedIn上发展个人品牌的一体化人工智能工具。使用 Soshial，您将获得：
-人工智能驱动的内容创作：快速生成引人入胜的帖子和轮播。Soshial的人工智能有助于制作能引起受众共鸣的内容，从而比以往任何时候都更容易分享有价值的见解。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/soshial?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Video to Prompt Generator是一款免费的人工智能工具，可以准确识别视频内容，允许通过聊天机器人进行交互，生成摘要，并为类似视频创建提示。轻松将视频转换为提示并在线描述视频。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/video-to-prompt-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
