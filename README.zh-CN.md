...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?message=生成人工智能应用的数量&color=informational&style=flat-square&label=2002" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
#### TextIn.AI PDF 转 Markdown，你的终极 PDF 解析器-在 1.5 秒内完成 100 个 PDF 到 Markdown！！
...
来看看 TextIn.ai 的杀手级 PDF 转 Markdown 文档解析器。它从 PDF 或图像中获取文本，然后像魔法一样将其排列顺序。它旨在处理复杂的文档结构，包括表格、图表和格式化文本，并以 LLM 易于解释的 markdown 或 JSON 格式输出结果。非常适合增强 LLM 的数据清理和解析。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/textin-ai-pdf-to-markdown?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 使用 AI 工具高效创建和优化小红书笔记。


[Visit](https://thataicollection.com/redirect/xhsplus?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

使用我们强大的 AI 工具套件轻松创建小红书笔记，包括 AI 重写生成器、AI 文本生成器和 AI 标题生成器！


[More Information and Pricing](https://thataicollection.com/zh-CN/application/xhsplus?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 由 FLUX.1 模型提供支持的 Flux AI 图像生成器
...
Flux AI 图像生成器由 FLUX.1 模型提供支持，是一款由黑森林实验室开源的尖端人工智能图像创建工具。它在制作高度详细的图像、准确地遵循提示、提供多样的艺术风格以及轻松处理复杂场景方面大放异彩。



[More Information and Pricing](https://thataicollection.com/zh-CN/application/flux-ai-image-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### iConGen-使用我们的 AI 驱动的图标生成器创建精美的图标


[Visit](https://thataicollection.com/redirect/icongen?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

iConGen 是一款人工智能驱动的工具，可以在几秒钟内轻松创建高质量的自定义图标。凭借其友好的用户界面和高级功能，它允许设计师和内容创作者为任何项目生成独特的图标，而无需技术技能。iConGen 非常适合优化创意工作流程，可快速轻松地将您的想法转化为出色的图标。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/icongen?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
AI Anime Generator提供了易于使用的界面和简化的工具，使任何年龄的用户都可以进行动画创作。无论您是年轻人还是老年人，该平台的直观设计都可以帮助您快速生成所需的动漫图像。您可以毫不费力地设计角色、创建生动的场景并制作引人注目的视觉效果。 


[More Information and Pricing](https://thataicollection.com/zh-CN/application/ai-anime-generator-free?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
TalkForce AI 提供基于人工智能的创新客户服务解决方案，旨在通过全天候支持提高客户满意度、简化操作并显著降低运营成本。通过自动进行例行查询、安排预约以及提供友好和专业的支持，我们的 AI 助手使您的团队能够专注于提供卓越的个性化服务。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/talkforce-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Cinematic 使用 AI 自动为您或您的品牌创建热门社交媒体视频。

抖音和Instagram Reels等平台的趋势一直在变化，几乎无法跟上。借助Cinematic，您可以保持领先地位，自动生成更有可能增加观看次数和关注者的视频。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/cinematic?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
