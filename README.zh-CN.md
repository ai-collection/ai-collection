...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?message=生成人工智能应用的数量&color=informational&style=flat-square&label=3817" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
imagetranslator.com：强大的人工智能平台，用于翻译 100 多种语言的图像文本。准确翻译标签、手册和广告。它是全球业务的理想之选，它打破了语言障碍，促进了电子商务、公司和个人的沟通和本地化。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/image-translator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 在线免费 PDF 翻译器-即时 AI 驱动的文档翻译 | 免费 PDF 翻译器
...
PDF 翻译器：上传您的 PDF，从 100 多种语言中选择源语言和目标语言，并免费下载保留格式的翻译。基于人工智能的商业报告、学术论文、旅行指南工具，无需注册，即时获得结果。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/pdf-translator-free?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Nano Banana Pro-使用 Gemini 3 Pro 的人工智能图像生成器和照片编辑器
...
Nano Banana Pro 是一款专业的人工智能图像生成器和照片编辑器，由 Gemini 3 Pro 技术提供支持。使用我们先进的 AI 图像编辑器，使用 100 多种语言的完美文本渲染创建令人惊叹的 4K 图像。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/nano-banana-pro-gemini-3?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 使用具有可靠结构、清晰度和高分辨率输出的 Nano Banana AI 生成精美的视觉效果。
...
nanoBananaproai.com 提供了一款在 Nano Banana Pro 上运行的完全免费的 Nano Banana AI 图像编辑器。它支持基于文本的生成和基于照片的调整，提供灵活的构图、细致的表面、稳定的角色特征和清晰的文本处理。用户可以创建新图像或以不同的比率和分辨率优化现有图像。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/nanobananaproai-com：free-nano-banana-ai-image-editor?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Kie.ai 上的 Nano Banana Pro API — 由 Gemini 3 Pro 提供支持的原生 1K/2K/4K 图像生成
...
Kie.ai 上的 Nano Banana Pro API 由 Gemini 3 Pro 图像堆栈提供支持，支持原生 1K、2K 和 4K 图像生成，具有更清晰的细节、简洁的排版和一致的角色身份，无需外部升级。Kie.ai 专为开发人员设计，为生产工作流程提供经济实惠的信用定价、商业用途和简单的 API 集成。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/nano-banana-pro-api-on-kie-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 使用 Grok Imagine 视频生成器免费生成病毒视频和图像，包括动态辣味模式，以增加创造力。
...
Ximagine.io 是一款免费的 Grok Imagine 视频生成器，可将文本或图像转换为动态、高冲击力的动画片段。它由 Grok Imagine v0.9 提供支持，可确保流畅的过渡、一致的角色身份、同步的声音和艺术视觉效果。借助 “普通”、“娱乐” 和 “辛辣” 等模式，创作者可以轻松制作电影视频、超现实实验或病毒内容。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/ximagine-io：free-grok-imagine-video-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
