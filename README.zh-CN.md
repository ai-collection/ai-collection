...
只需点击几下，即可转录视频，自动生成字幕，并轻松将其翻译成多种语言。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/subtitlegen?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 使用 Quizcat 人工智能工具对您的学习过程进行个性化设置。 


[Visit](https://thataicollection.com/redirect/quiz-cat?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Quizcat AI 通过将笔记转换为交互式工具，帮助学生和专业人士更智能地学习。通过根据您的需求量身定制的测验、抽认卡和播客，它可以确保更好的留存率和有效的审阅。抽认卡提供快速的概念复习、测验、测试理解，播客允许随时随地学习。S


[More Information and Pricing](https://thataicollection.com/zh-CN/application/quiz-cat?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Blunge 允许你根据自己的私密风格训练自己的图像生成模型。您只需要提供大约 10 张图像来代表您想要训练的风格，几个小时后，您可以使用自己的私有 AI 模型生成图像。 


[More Information and Pricing](https://thataicollection.com/zh-CN/application/blunge?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### MathGPT-免费的人工智能数学求解器和积分计算器


[Visit](https://thataicollection.com/redirect/mathgpt-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

MathGPT 是一款先进的人工智能数学求解工具。使用照片数学 AI 求解器和积分计算器逐步解决任何数学问题。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/mathgpt-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
