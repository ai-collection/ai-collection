...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?label=%E7%94%9F%E6%88%90%E4%BA%BA%E5%B7%A5%E6%99%BA%E8%83%BD%E5%BA%94%E7%94%A8%E7%9A%84%E6%95%B0%E9%87%8F&message=3376&color=informational&style=flat-square" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="类别数" src="https://img.shields.io/static/v1?label=%E7%B1%BB%E5%88%AB%E6%95%B0&message=87&color=informational&style=flat-square" />
</a>
...
<div align="center">
    ...
    <h4>Agentic AI 制作工作室可实现一致的角色、工作流程和视频</h4>
    <p>一个支持代理的端到端 AI 制作创意平台：训练 LoRA 以保持角色和品牌的一致性，在 Flow Studio 中连接多步流水线，在时间轴视频编辑器中汇编短片，并通过浏览器或专为 AI 助手构建的 tft CLI 进行全部驱动。还要通过图像引用保持一致性。</p>
    <a href="https://thataicollection.com/redirect/thefluxtrain" target="_blank"><b>开始使用 TheFluxTrain</b></a>
    <br />
</div>
...
<div align="center">
    ...
    <h4>justcopy.ai-无需任何设置即可在 2 分钟内复制、自定义和部署的 AI 代理</h4>
    <p>JustCopy.ai 可以让任何人在几分钟内从创意转变为在线网站。在 10 秒内复制任何现有站点，或使用 AI 生成一个新的站点，自动设计、编码和部署，无需设置，无需工程。</p>
    <a href="https://thataicollection.com/redirect/justcopy-ai" target="_blank"><b>开始使用 JustCopy AI</b></a>
    <br />
</div>
...
#### 二维码菜单、配送和在线订购 | MenuForma


[Visit](https://thataicollection.com/redirect/menuforma?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

免费的人工智能二维菜单生成器，适用于提供人工智能食物照片、在线订购和 70 多种语言支持的餐厅。— 二维码菜单、送货和在线订购 | MenuForma


[More Information and Pricing](https://thataicollection.com/zh-CN/application/menuforma?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Seedance 2.5 AI 视频生成器-已在 AI 系列中上市
...
基于浏览器的 AI 视频生成器，可根据文本、图像、视频或 3D 参考资料（最多 50 个输入）创建多达 30 秒的电影 4K 片段。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/seedance-2-5-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
用于即时化妆分析的人工智能美容应用程序、24 份人工智能报告、300 多种造型、100 多个教程、个性化计划和 AI 美容聊天。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/makeup-check-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Krea 2 AI 图像生成器-已上架 AI Collection


[Visit](https://thataicollection.com/redirect/krea-2-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

基于浏览器的AI图像生成器，可将文本提示和照片转换为具有多种样式和图像间编辑的高分辨率图像。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/krea-2-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### GPT Image 2 和 Nano Banana 2 免费试用 | Pixocto AI — AI 图像和视频


[Visit](https://thataicollection.com/redirect/pixocto-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

在 pixocto 上试用 GPT Image 2 和 Nano Banana 2 ——带有参考文献和 4K 级输出的人工智能剧照，外加人工智能视频（Seedance）、注册积分、透明的即用即付定价。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/pixocto-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Veo 4是谷歌DeepMind的人工智能视频生成和图像编辑平台。根据简单的文字提示创建电影视频、编辑照片并融合图像。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/veo-4-ai-video-generator-veo-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Tenorshare AI Diagrimo-在线免费人工智能图表生成器


[Visit](https://thataicollection.com/redirect/diagrimo?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Diagrimo 是一款人工智能驱动的图表制作工具，可快速将想法转化为清晰的图表和信息图表。轻松自定义、导出和共享。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/diagrimo?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### ClaviSay | 用于真实内容的 AI 语言学习助手


[Visit](https://thataicollection.com/redirect/clavisay?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

AI 助手可将文章、PDF、网页和视频转换为双语阅读、上下文解释、词汇、摘要和评论。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/clavisay?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### AI 图像生成器：在线文本到图像和图像到图像-Xole AI
...
使用我们先进的 AI 图像生成器释放您的创造力。将简单的文字提示或图像变成令人叹为观止的艺术品、超逼真的照片和设计。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/xole-ai-image-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### MarsX 是一款将 AI、NoCode、Code 和微应用程序结合在一起的开发工具


[Visit](https://thataicollection.com/redirect/marsx?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

人工智能驱动的编码平台（开发工具）可在几天内构建 SaaS 工具！MarsX/marsAI 或 Mars AI。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/marsx?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
编辑网站将机器人吸尘器与人工智能顾问进行比较，查看共识、规格、所有者反馈和并排比较表。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/best-robot-vacuum?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### UrltoVideo AI-电子商务产品页面的人工智能视频生成器
...
通过产品网址（Shopify、亚马逊、抖音商店）自动生成电子商务视频广告。包括头像、脚本和语音。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/urltovideo-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Seedance 2.1 API | 多模式 AI 视频生成 | Kinovi
...
如今，Kinovi提供了经济实惠的Seedance 2.0视频生成渠道，并通过清晰的模型页面、可预测的信用定价和便于开发者的访问权限，帮助团队准备Seedance 2.1 API工作流程。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/seedance-2-0-and-2-1-api-by-kinovi?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
AI 视频生成器，可将文本、照片、片段和音频转换为具有原生音频和 30fps 流畅动作的 4K 电影视频。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/seedance-2-5?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
使用 AI 语音代理实现对外销售自动化。确认潜在客户、预约、全天候跟进。活两周。转化率提高了 63%。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/topcalls?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Voicv 提供先进的人工智能语音克隆、文字转语音 (TTS) 和语音转文本 (ASR) 服务。使用尖端技术创建、转换和转换音频，支持多种语言和情感。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/voicv?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
免费生成听起来和你完全一样的逼真 AI 语音克隆。无需订阅，无限使用。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/free-voice-cloning?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### NiceVoice-免费的 AI 语音克隆工具


[Visit](https://thataicollection.com/redirect/nicevoice?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

使用我们尖端的人工智能技术，在几秒钟内克隆你的声音。用自己的声音从任何文本中创建听起来自然的语音。免费安全的语音克隆服务。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/nicevoice?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### AI 驱动的水印去除器-免费、快速、易于使用


[Visit](https://thataicollection.com/redirect/ipurix?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

使用我们的免费 AI 工具轻松去除图像中的水印。快速而简单，无需登录。几秒钟内即可获得干净、无水印的照片。现在就试试吧！


[More Information and Pricing](https://thataicollection.com/zh-CN/application/ipurix?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
