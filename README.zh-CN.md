...
#### PromptCurator • 适用于 macOS 的个人 AI 提示库
...
使用变量构建、整理和重复使用您的 AI 提示。专为想要简化 AI 工作流程的高级用户而设的 macOS 应用程序。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/promptcurator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
AIAI 是 AI 驱动的终极平台，用于创建精彩的视频、图像、语音和文本内容。使用我们的高级 AI 工具来生成内容，加入超过 5 万名创作者的行列。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/aiai-com?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
