...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?message=生成人工智能应用的数量&color=informational&style=flat-square&label=3231" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
#### AI 内容探测器：适用于 ChatGPT、Claude 和 Gemini 的 AI 检查器
...
我们的 AI 内容检测器可帮助您确定文本是由人类编写的还是由人工智能（包括 ChatGPT）生成的。它可以准确识别人工智能生成、解释和人工编写的内容。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/decopy-ai-content-detector?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
eFinder 可满足您的所有电子邮件提取需求，并根据用户反馈不断发展
作为高级电子邮件提取器扩展程序，它在功能和易用性方面都优于电子邮件提取器1.4和电子邮件提取器1.6。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/efinder?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
使用我们的高级修复工具探索人工智能驱动的图像编辑的力量。使用尖端的人工智能无缝恢复、增强和转换您的照片。非常适合寻求提升视觉内容的摄影师、设计师和创意专业人士。体验直观的控件、实时预览和专业级结果。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/ai-inpainting?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
MinutesLink是一款基于人工智能的笔记助手，用于在线通话。即使用户不在，它也会自动加入已安排的会议，并提供可以轻松编辑和共享的录音、详细的记录和准确的会议记录。MinutesLink 通过轻松提供录音、笔录和可共享的会议记录来简化会议管理。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/minuteslink-ai-note-taker?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
