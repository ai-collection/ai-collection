...
具有 20 多个尖端模型的多合一人工智能视觉创作平台。在一个统一的平台上生成图像、生成视频和创建音频。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/monet-vision?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Onda AI 将您的播客收听转换为智能的可搜索笔记。记录每条报价、关键见解和摘要，这样您就可以记住并运用所学内容。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/onda-ai-audio-note-taker?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
