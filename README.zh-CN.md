...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?message=生成人工智能应用的数量&color=informational&style=flat-square&label=3012" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
X 图像生成器是一款先进的 AI 图像生成工具，旨在将文字描述转换为精美的图像艺术。无论是创建各种风格的角色、场景还是图像，X 图像生成器都能满足用户的需求。该工具不仅易于使用，而且完全免费，适合所有想要释放创造力的用户。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/x-image-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 你最好的 AI 图像助手和 AI 图像工具箱-Crayon AI


[Visit](https://thataicollection.com/redirect/crayon-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Crayon AI 提供了一套全面的工具，旨在增强您的创作过程。借助图像生成、照片编辑器、恢复照片、图像调整器和质量优化等功能，您可以毫不费力地将想法变为现实。我们的图像工具箱简化了照片编辑，允许无缝替换和裁剪，确保您的图像每次都看起来很漂亮。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/crayon-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### AnimeGen是一个创新平台，它利用先进的人工智能技术将您的提示转换为精美的动漫图像。
...
友好的用户界面：轻松浏览我们的网站并在几秒钟内生成图像。
无限创意：输入任何提示，观看我们的人工智能根据您的描述创建独特的动漫图片。
完全免费：享受所有功能，无需任何费用或隐性费用。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/animegen-anime-image-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
LunaSleep.ai 是一款由人工智能驱动的睡眠顾问，专为宝宝的父母设计。它通过WhatsApp提供个性化的全天候支持，根据每个孩子的独特需求提供睡眠计划和建议。Luna 可以帮助解决睡眠回归和睡眠训练等常见问题。它是传统睡眠教练的一种经济实惠的替代方案，每月仅需29美元，即可提供无限制的按需消息。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/luna-sleep?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 是或否塔罗牌可以快速解答您的日常问题。只要问，抽一张牌，然后得到一张简单的 “是”、“否”，或者可以帮助指导你的选择。
...
是或否塔罗牌是一种直截了当的塔罗牌阅读风格，旨在快速回答你的问题。与涉及复杂点差和解释的传统塔罗牌读物不同，塔罗牌侧重于提供简单、直接的回应，例如 “是”、“否” 或 “可能”。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/tarot-yes-or-no?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
把你的故事变成漫画！AI Comic Factory 使用 AI 从文本生成精美的漫画书。易于使用的漫画书生成器，适合所有人。无需绘画技能。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/ai-caricature?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
