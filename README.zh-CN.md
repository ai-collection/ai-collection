...
免费的 AI 日语名字生成器！查找具有含义和发音的真实姓名（汉字、平假名、片假名）。非常适合创作者和日本爱好者


[More Information and Pricing](https://thataicollection.com/zh-CN/application/best-free-ai-japanese-name-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### reap-一款基于人工智能的视频再利用工具 


[Visit](https://thataicollection.com/redirect/reap?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

reap 是一款基于人工智能的视频再利用工具，可将长视频、播客、网络研讨会即时转换为病毒式短片和卷轴。 
无论你是创作者、营销人员还是游戏玩家，它都能自动编辑、添加字幕并最大限度地扩大覆盖范围，这样你就可以更快地成长！ 


[More Information and Pricing](https://thataicollection.com/zh-CN/application/reap?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Markdown 到 PDF 转换器和丰富的 Markdown 编辑器


[Visit](https://thataicollection.com/redirect/md2file?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

MD2FILE 是一款强大的降价编辑器和转换器，提供所见即所得控件、实时预览、LaTeX 数学支持、美人鱼图以及无缝导出到 PDF/HTML。非常适合希望轻松创建精美专业文档的开发人员、作家和教育工作者。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/md2file?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### AI Kungfu是一款有趣又简单的工具，可以在几秒钟内将你的照片变成真实的武术视频。


[Visit](https://thataicollection.com/redirect/ai-kungfu?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

AI Kungfu是一个创新的人工智能平台，可将普通照片转换为动态武术视频。它使用先进的人工智能技术，分析照片并应用真实的功夫动作来创建逼真的武术动画。 


[More Information and Pricing](https://thataicollection.com/zh-CN/application/ai-kungfu?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Rizz App AI — 由 AI 驱动的终极 Rizz Line 生成器
...
正在寻找最好的 rizz 台词？Rizz App AI 可为任何场合提供人工智能生成的接听线路——流畅、滑稽、性感或肮脏。它针对最佳 rizz 台词和 w rizz 热线等热门搜索进行了优化，是提升游戏水平的 #1 平台。每月有超过25万次的搜索量，可以毫不费力地滑入DM或在现实生活中留下深刻的印象。

👉 立即在 Rizzappai.com 试一试 🚀


[More Information and Pricing](https://thataicollection.com/zh-CN/application/rizz-app-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
使用我们的 “是或否” 预言机和 “命运之轮” 自信地做出决定。通过塔罗牌、易经和Omikuji的读物探索更深入的见解。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/yes-no-oracle?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
