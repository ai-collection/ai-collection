...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?message=生成人工智能应用的数量&color=informational&style=flat-square&label=3202" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
#### 由 AI 驱动的 Trello PowerUps 可提高团队工作效率


[Visit](https://thataicollection.com/redirect/geeksight?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Geeksight 为 Trello 开发了人工智能增强型强化道具，彻底改变了团队的工作效率。我们的工具将人工智能驱动的笔记、智能文档管理和以用户为中心的设计直接集成到 Trello 工作流程中。我们正在通过直观的功能扩展 Trello 的功能，以促进更好的协作、简化流程并让团队专注于最重要的事情。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/geeksight?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
免费的 4o 图像生成器和可动人偶创建器——在线设计高质量的艺术品、3D 角色和自定义人物。非常适合艺术家和游戏开发者。



[More Information and Pricing](https://thataicollection.com/zh-CN/application/4o-image-generatorand-action-figureand-ai-barbie-doll?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 我们是一个多合一的电子商务创意解决方案，人工智能图像工具
AI 模型：各种不同肤色和外观的 AI 模型；辅助功能-Upscale/Hand Repair/Repaint/Eraser Pen


[Visit](https://thataicollection.com/redirect/aogen?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

1）AI 模型：各种不同肤色和外观的 AI 模型
2）高档：使用升频器增强图像以开始视觉复兴
3）手部修复：轻松优化图像中手部缺陷的问题
4）重绘：将图像中不令人满意的部分转换为所需的内容 
5）橡皮笔：自动清除障碍物，适用于消除小物体


[More Information and Pricing](https://thataicollection.com/zh-CN/application/aogen?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Hypnothera-按需个性化 AI 催眠疗法


[Visit](https://thataicollection.com/redirect/hypnothera?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Hypnothera是一个由人工智能驱动的创新催眠治疗平台，它彻底改变了个人成长和心理健康支持。利用先进的人工智能，Hypnothera根据每位用户的独特需求和目标量身定制个性化催眠疗法。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/hypnothera?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Tidio 的 Lyro 是一款基于人工智能的聊天机器人，旨在简化企业的客户支持。它使用自然语言处理来实时理解和回应客户的询问，从而减少了人工干预的需求。Lyro 可以与您的网站集成并支持多种语言，使其成为一款多功能工具，能够解决高达 64% 的票证。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/lyro-the-ai-agent-for-customer-service?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
