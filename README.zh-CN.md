...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?message=生成人工智能应用的数量&color=informational&style=flat-square&label=4316" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
#### Sonant AI 语音代理在保险机构中执行端到端的例行任务和通话。自动完成 90% 的任务：保单续保、AI 保险报价、收款、全天候保险接待员等。


[Visit](https://thataicollection.com/redirect/sonant-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Sonant 是一款面向保险机构的人工智能解决方案，为保险机构提供 TaI 员工队伍，以简化运营和增强客户服务。Sonant AI 语音代理可以处理各种任务，包括保单续订、报价培育、潜在客户资格认证和全天候客户支持。Sonant 的人工智能接待员可与现有的机构管理系统无缝集成。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/sonant-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Calvin 是一款人工智能驱动的应用程序，可将你的口头想法变成短视频。它旨在简化视频创作过程，尤其是社交媒体内容。
...
Calvin旨在消除视频制作中的技术障碍，允许任何人无需视频编辑技能即可创建内容。对于想要快速轻松地制作社交媒体视频的人来说，它很有用。

该应用程序使用人工智能来解释你的想法并将其转化为视觉内容，从而将通常的多步骤编辑过程简化为一个单一的语音激活操作。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/calvin-ai-short-video-creator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
使用 AI for Google 幻灯片，使用 AI 快速创建新的专业演示文稿。谷歌幻灯片的人工智能是一个易于使用的插件，它使用户可以直接在谷歌幻灯片中使用人工智能轻松创建新的演示文稿和编辑旧演示文稿。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/ai-for-google-slides?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
PriceListTemplate是一个创新平台，它简化了使用人工智能创建专业价目表的过程。无论您是营销人员、创业公司还是企业家，PriceListTemplate都提供了直观且用户友好的界面，可让您快速创建精美的高转化率价目表。   


[More Information and Pricing](https://thataicollection.com/zh-CN/application/price-list-template?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 满怀信心地推销您的游戏。在几分钟内获得持续有效的视频广告——由 AI 制作和优化
...
毫不费力的 AI 广告。Reforged Labs是一个为游戏营销制作和优化视频广告的平台。我们使用 GenAI 和广告情报来构建和完善视频创意，为游戏工作室提供更快的实验和更高的广告回报率


[More Information and Pricing](https://thataicollection.com/zh-CN/application/reforged-labs?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
增强 AirBnB 房客留言回复量。通过有用、一致且针对房客的消息，更快地回复房客。 

你是爱彼迎房东吗？你是兼顾多处房源，努力跟上房客留言的步伐吗？SnappyReply 是你的解决方案！这款强大的 Chrome 扩展程序可以即时为您的房客生成个性化回复，从而节省您的时间并改善您的出租体验。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/snappyreply?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 在 ExamFul.ai 上免费试卷和 AI 辅导，成功参加 AP、IB 和 A Level 考试！ 
...
ExamFul.ai 让学生全面访问丰富的 AP、IB 和 A-Level 过去的论文库，以及人工智能驱动的全天候辅导。ExamFul.ai 可免费在线访问，无需注册，是您成功考试的可靠合作伙伴。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/examful-ai-free-ap-ib-and-a-level-past-papers-and-tutoring?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
