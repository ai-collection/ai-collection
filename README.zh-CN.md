...
Maxim 是一个用于构建 AI 应用程序的堆栈，使现代 AI 团队能够交付具有质量、可靠性和速度的产品。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/maxim-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 自由文字转语音，超过 200 种语音和 70 种语言，没有字数限制


[Visit](https://thataicollection.com/redirect/luvvoice?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Luvvoice提供免费在线服务，可免费将文本转换为语音（TTS）。只需输入文本，选择语音，然后下载生成的 mp3 文件或直接收听即可。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/luvvoice?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
