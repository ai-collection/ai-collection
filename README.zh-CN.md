...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?message=生成人工智能应用的数量&color=informational&style=flat-square&label=2730" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
#### 一个使用您自己的数据轻松创建、训练人工智能聊天机器人并与之聊天的平台。
...
MyChatbots.AI 是一款创新的 AI 聊天机器人工具，专为个人和企业用途而设计。它允许用户创建自定义的人工智能聊天机器人，根据自己的数据对他们进行培训，并参与高级对话。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/mychatbots-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### GPT Bypass 将 AI 生成的文本人性化，以绕过内容检测。 


[Visit](https://thataicollection.com/redirect/gpt-bypass?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

GPT Bypass 使 AI 生成的文本人性化，可以绕过内容检测。-100% 免费使用，无需注册。-没有使用限制，可以根据需要经常使用。-高效可靠，保持文本的原始含义，同时使其看起来更像人类。-非常适合博主、营销人员、学生和任何需要类人内容的人。-只需访问该网站


[More Information and Pricing](https://thataicollection.com/zh-CN/application/gpt-bypass?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Pokecut是一款人工智能驱动的照片编辑工具，可以免费执行各种图像编辑功能，例如背景去除器，照片增强器，背景更改器。
...
Pokecut 旨在帮助用户创建专业的工作室品质的图像。除了背景去除器、照片增强器、背景更改器等AI功能外，大量的背景模板和设计资源也可以帮助您轻松创建高质量的照片。未来将推出更多的人工智能功能。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/pokecut-ai-powered-online-photo-editor?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
从巫师到勇士，以及介于两者之间的一切，用我们令人惊叹的 AI 声音让你的角色变为现实。Replica 提供文本转语音、语音转语音和 API 以适合您的项目。库中有超过 130 种声音，并且能够混合声音来创建独特的角色，可能性是无限的。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/replica-studios?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 在几秒钟内创建自定义徽标——免费、快速、专业。


[Visit](https://thataicollection.com/redirect/slea-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Slea.ai：你的终极免费 AI 徽标制作器！无需下载或掌握任何技术技能，即可在几秒钟内将创意转化为精美的专业徽标。




[More Information and Pricing](https://thataicollection.com/zh-CN/application/slea-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 尤里卡是世界上第一位人工智能医生。尤里卡可以订购实验室并在现实世界中提供医疗保险。 
...
尤里卡是一位人工智能医生，为甲状腺疾病提供个性化的现实护理。它能够在持牌医生的监督下订购实验室并提供切实可行的护理建议。费用由健康保险支付。Eureka 为医疗保健带来了人工智能的精华：速度、个性化和持续改进。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/eureka-health?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
