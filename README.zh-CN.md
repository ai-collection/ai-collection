...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?message=生成人工智能应用的数量&color=informational&style=flat-square&label=3443" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
<div align="center">
    ...
    <h4>Humanize Ai-将人工智能生成的内容转化为人类写作</h4>
    <p>Humanize AI 将机器人人工智能生成的文本转换为绕过人工智能探测器的自然类似人类的内容。使用它来重写博客、电子邮件、文章等，具有 HumanoIDX 模型、自动博客作者和检测器安全输出等高级功能。thehumanizeai.pro 提供免费和高级套餐。</p>
    <a href="https://thataicollection.com/redirect/the-humanize-ai-pro" target="_blank"><b>开始使用 The Humanize Ai Pro</b></a>
    <br />
</div>
...
#### Flux LoRa AI 图像生成器-在线试用 Flux LoRa AI
...
使用 Flux LoRa AI 图像生成器生成您的艺术图像。在 Fluxlora.top 上，你可以使用 flux LoRa 创建各种艺术风格的图像，生成著名名人的肖像


[More Information and Pricing](https://thataicollection.com/zh-CN/application/flux-lora-ai-image-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
一个免费且易于使用的摩尔斯电码生成器和制作器。轻松将摩尔斯电码翻译成文本，将文本翻译成摩尔斯电码，将摩尔斯电码翻译成声音和灯光。支持字母语言：拉丁字母、西里尔字母、希腊字母、希伯来字母、阿拉伯字母、波斯字母、日语字母、韩语字母、泰语字母。
网址




[More Information and Pricing](https://thataicollection.com/zh-CN/application/morse-code-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
AI Song Maker是一个由人工智能驱动的平台，可将文本和歌词转换为自定义歌曲。轻松创作、混音和制作各种风格的免版税音乐。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/ai-song-maker?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 不断演进下一代高级文本到图像的开放模型，支持 flux.1 pro/dev 和 flux.1 schnell models.Flux AI Image Maker Online-高级文本转图像工具
...
使用 Flux AI Image Maker: Flux Schnell 来快速创作，使用 Flux Dev 进行细致定制，使用 Flux Pro 来改变你的视觉效果，使用无与伦比的专业素


[More Information and Pricing](https://thataicollection.com/zh-CN/application/advanced-text-to-image-flux-ai-image-maker?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
