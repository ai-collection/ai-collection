...
<div align="center">
    ...
    <h4>使用 AI 工具轻松生成和编辑图像</h4>
    <p>PicTools AI 提供了强大的 AI 工具，可以创建精美的图像、删除背景、模糊照片等。快速、简单，专为您的创造力而设计！</p>
    <a href="https://thataicollection.com/redirect/pictools-ai" target="_blank"><b>开始使用 PicTools.AI</b></a>
    <br />
</div>
