...
使用实时字幕将您的直播翻译成 30 多种语言。适用于 OBS、Streamlabs、Twitch、YouTube、Kick。最简单的直播翻译器 — 60 秒设置，6 小时免费试用。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/streamtranslate?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Geolify：购买 GEO 套餐并在 ChatGPT、Claude 等中排名


[Visit](https://thataicollection.com/redirect/geolify?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

从 Geolify 购买 GEO 套餐，在 ChatGPT、Claude、Gemini、Perplexity 和 Google AI 概述中对您的品牌进行排名。AI 可见度包旨在让你被生成式搜索引擎引用。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/geolify?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Genra AI — 免费的人工智能视频生成器和代理 | 视频聊天


[Visit](https://thataicollection.com/redirect/genra-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Genra AI 是一款免费的人工智能视频生成器和代理。通过聊天创建多场景视频。无需编辑技能，只需描述您的想法即可。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/genra-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
