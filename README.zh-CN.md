...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="生成人工智能应用的数量" src="https://img.shields.io/static/v1?message=生成人工智能应用的数量&color=informational&style=flat-square&label=3870" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
#### Dewy.Chat 是一个 AI 聊天机器人平台，用于交互式讲故事、角色对话以及通过对话探索虚构世界。


[Visit](https://thataicollection.com/redirect/dewy-chat?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Dewy.Chat 是一个以对话为先的人工智能聊天机器人平台，专注于交互式讲故事和角色驱动的体验。用户可以与具有独特个性和背景的人工智能角色聊天，探索不同的流派，并通过基于文本的对话创建自己的角色和世界。  


[More Information and Pricing](https://thataicollection.com/zh-CN/application/dewy-chat?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
Visual Field Test 是一款在线工具，旨在帮助用户在家中舒适地检测盲点并评估其周边视力。该基于网络的应用程序模拟专业的视野测试程序，允许个人筛查潜在的视力问题，这些问题可能表明诸如青光眼、视网膜疾病或影响视力的神经系统问题等疾病。 


[More Information and Pricing](https://thataicollection.com/zh-CN/application/visual-field-test?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 纳米香蕉、纳米香蕉 2 和 Nano Banana Pro-高级 AI 图像生成器
...
纳米香蕉、纳米香蕉 2 和 Nano Banana Pro-高级 AI 图像生成器
体验由谷歌 Gemini 2.5 Flash Image API 提供支持的纳米香蕉人工智能。现在以纳米香蕉 2 和纳米香蕉专业版为特色，采用 Gemini 3 Pro Image 和工作室质量控制。使用自然语言命令转换图像，实现卓越的字符一致性（最多 5 个字符）和清晰的文本渲染。 


[More Information and Pricing](https://thataicollection.com/zh-CN/application/nano-banana-ai-pro?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
借助Seedance 1.5的先进的人工智能技术，将你的想法转化为精彩的视频。利用多镜头叙事、精确的物理动作和文字提示或图像的电影画质，创建专业的 1080p 视频。




[More Information and Pricing](https://thataicollection.com/zh-CN/application/seedance-1-5?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Drezily AI 驱动的个人购物助手。它具有对话式搜索和图像输入等功能，可帮助您在数百万种产品和多个商店中准确找到所需的内容。


[Visit](https://thataicollection.com/redirect/drezily?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Drezily是一个由人工智能驱动的时尚发现和购物平台，可帮助用户在高端零售商中找到个性化服装和最优惠的价格。Drezily 将基于聊天的搜索、图像识别和智能产品匹配相结合，使购物者可以轻松描述、上传或搜索款式，并即时查看多家商店的选项。 


[More Information and Pricing](https://thataicollection.com/zh-CN/application/drezily?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
DeepSwapai是一个人工智能驱动的人脸交换平台，为没有水印的照片和视频提供免费的在线面部替换，以及供开发人员集成面部交换功能的专业API。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/deep-swap-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
