...
免费的 AI 驱动的音频到文本的转录。使用 Whisper 技术将音频文件、视频和 YouTube 转录为准确的文本。10 多种语言。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/transpocket?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Modelfy 3D-AI 图像到 3D 模型生成器


[Visit](https://thataicollection.com/redirect/modelfy-3d?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

使用我们先进的 AI 图像转 3D 生成器，立即将任何图像转换为 3D 模型。在几秒钟内将 2D 图像转换为 3D 模型-用于 3D 打印、游戏和专业项目的免费在线工具。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/modelfy-3d?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Nano Banana 2 Pro — 具有角色一致性的免费 AI 图像生成器 | Lovart
...
使用 Nano Banana 2 Pro 生成具有卓越字符一致性的图像。由谷歌 AI 提供支持。使用自然语言创建专业的视觉效果。免费使用，无需注册。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/lovart-al-nano-banana-ai-image-generator?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### 免费立即使用 GPT-OSS 模型 | gptoss.ai


[Visit](https://thataicollection.com/redirect/gpt-oss?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

免费即时访问强大的 GPT-OSS 模型，无需等候名单！我们的开源 AI 平台是生成、推理和创建的最快方式。今天就在 gptoss.ai 开始你的下一个好主意吧！


[More Information and Pricing](https://thataicollection.com/zh-CN/application/gpt-oss?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
最智能的人工智能人性化工具，用于让 ChatGPT、Claude 和其他人工智能生成的文本听起来像人类。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/humanizethat?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
仅凭您的声音即可创建令人惊叹的人工智能视频。使用先进的语音转视频技术，在几分钟内上传音频、添加自定义头像并生成专业视频内容。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/speechtovideo?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Assista — 使用自动驾驶模式运行每个部门


[Visit](https://thataicollection.com/redirect/assista-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

Assista是一个人工智能运营团队，致力于将目标转化为已完成的工作。设定目标，首席执行官代理人组建专家团队，连接您的应用程序，并保持执行——按计划、按触发条件，在重要时由您批准。


[More Information and Pricing](https://thataicollection.com/zh-CN/application/assista-ai?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
