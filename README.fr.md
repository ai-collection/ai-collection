...
<a href="https://github.com/ai-collection/ai-collection">
    <img alt="Nombre d'applications d'IA générative" src="https://img.shields.io/static/v1?message=Nombre d'applications d'IA générative&color=informational&style=flat-square&label=1620" />
</a> &nbsp;&nbsp;
<a href="https://github.com/ai-collection/ai-collection">
...
#### iVu.Ai est un moteur de recherche conversationnel piloté par IA qui fournit des réponses précises et détaillées à l'aide d'algorithmes avancés de traitement du langage naturel (NLP) et d'apprentissage automatique.
...
iVu.Ai est un moteur de recherche conversationnel piloté par IA qui fournit des réponses précises et détaillées à l'aide d'algorithmes avancés de traitement du langage naturel (NLP) et d'apprentissage automatique. Il effectue des recherches approfondies sur Internet, contextualise les informations et fournit des réponses claires et sourcées. Au-delà de la recherche, iVu.Ai peut extraire des données à partir d'URL, générer des images et inclut un module chatbot. 


[More Information and Pricing](https://thataicollection.com/fr/application/ivu-ai-powered-conversational-search-engine?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### Coloriages personnalisés générés par l'IA pour les enfants
...
Dad Can't Draw a débuté comme un outil CLI que j'utilisais pour créer des pages à colorier que mes enfants voulaient vraiment colorier. Ils s'ennuyaient avec leurs livres de coloriage achetés en magasin et demandaient un thème très créatif à colorier. 


[More Information and Pricing](https://thataicollection.com/fr/application/dad-cant-draw?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
...
#### NoteVocal est l'application de transcription audio destinée aux créateurs de contenu très actifs


[Visit](https://thataicollection.com/redirect/notevocal?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

NoteVocal est une application de transcription audio qui utilise l'API OpenAI Whisper. Les utilisateurs peuvent soit télécharger des fichiers audio d'une taille maximale de 25 Mo, soit s'enregistrer directement dans le navigateur de leur choix.
Plus de 50 styles personnalisés sont disponibles, d'autres étant ajoutés tous les jours (ou choisis le tien). Exporte des notes vers WhatsApp, au format PDF ou via Notion.  
