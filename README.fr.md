...
#### Génère des mises à jour de statut quotidiennes à partir de l'activité de Slack
...
dailystatus.ai est un outil actuellement en version bêta qui génère automatiquement des mises à jour sur le statut de l'équipe à partir de l'activité de Slack, permettant aux utilisateurs d'envoyer des rapports de progression transparents à l'ensemble de leur équipe. En version bêta, le service est gratuit, bien que certaines fonctionnalités soient encore en cours de développement.


[More Information and Pricing](https://thataicollection.com/fr/application/dailystatus?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
