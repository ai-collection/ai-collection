...
#### Libérez la puissance de l'IA : modèle de paramètres 745B pour le chat, le code et la créativité


[Visit](https://thataicollection.com/redirect/glm-5?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)

GLM 5 est un modèle d'IA de nouvelle génération qui offre des performances inégalées en matière de chat, de génération de code et de création d'images et de vidéos. Tirez parti de sa fenêtre contextuelle de 128 000 et de son raisonnement avancé pour créer une solution d'IA complète.


[More Information and Pricing](https://thataicollection.com/fr/application/glm-5?utm_source=aicollection&utm_medium=github&utm_campaign=aicollection)
